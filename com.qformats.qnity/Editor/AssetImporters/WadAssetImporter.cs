...
namespace Qnity
{
    ...
    public sealed class WadAssetImporter : ScriptedImporter
    {
        ...
        public override void OnImportAsset(AssetImportContext ctx)
        {
            if (palette == null)
            {
                palette = (LmpPalette)AssetDatabase.LoadAssetAtPath("Packages/com.triebworks.Qnity/Assets/palette.lmp", typeof(LmpPalette));
            }
            ...
            try
            {
                ...
                MaterialManager.Instance.AddWad(collection);
            }
            catch (Exception e)
            {
                br.Close();
